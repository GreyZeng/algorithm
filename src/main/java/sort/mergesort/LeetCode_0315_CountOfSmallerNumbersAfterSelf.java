 ...
 *
 * The counts array has the property where counts[i] is the number of smaller elements to the right
 * of nums[i].
 *
 *
 *
 * Example 1:
 *
 * Input: nums = [5,2,6,1] Output: [2,1,1,0] Explanation: To the right of 5 there are 2 smaller
 * elements (2 and 1). To the right of 2 there is only 1 smaller element (1). To the right of 6
...
public class LeetCode_0315_CountOfSmallerNumbersAfterSelf {
    ...
    // 思路转换为：一个数的右边有多少个数比它小！也等价于一个数的左边有多少个数比它大！
    // 改归并排序（从大到小）
