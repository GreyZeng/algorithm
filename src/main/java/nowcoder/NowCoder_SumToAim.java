...
public class NowCoder_SumToAim {
	...
	public static void main(String[] args) {
		/*
		 * Scanner in = new Scanner(System.in); int n = in.nextInt(); int aim =
		 * in.nextInt(); int[] arr = new int[n]; for (int i = 0; i < n; i++) { arr[i] =
		 * in.nextInt(); } List<List<Integer>> ans1 = twoSumAim(arr, aim);
		 * List<List<Integer>> ans2 = threeSumToAim(arr, aim); for (List<Integer> ans :
		 * ans1) { for (Integer i : ans) { System.out.print(i + " "); }
		 * System.out.println(); } for (List<Integer> ans : ans2) { for (Integer i :
		 * ans) { System.out.print(i + " "); } System.out.println(); } in.close();
		 */
