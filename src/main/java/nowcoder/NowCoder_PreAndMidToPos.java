...
public class NowCoder_PreAndMidToPos {
    ...
    public static void p2(char[] pre, int preL, int preR, char[] mid, int midL, int midR, char[] pos, int posL, int posR, HashMap<Character, Integer> map) {
        if (preL > preR) {
            return;
        }
        if (preL == preR) {
    ...
    public static void p(char[] pre, int preL, int preR, char[] mid, int midL, int midR, char[] pos, int posL, int posR) {
        if (preL > preR) {
            return;
        }
        if (preL == preR) {
