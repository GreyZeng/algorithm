...
// TODO
// An IP address is a formatted 32-bit unsigned integer where each group of 8 bits is printed as a
// decimal number and the
...
// matches
// 01111011 00101101 0100xxxx xxxxxxxx, where x can be either 0 or 1, is in the set covered by the
// CIDR block.
// You are given a start IP address ip and the number of IP addresses we need to cover n.
// Your goal is to use as few CIDR blocks as possible to cover all the IP addresses in the inclusive
// range [ip, ip + n - 1]
// exactly
...
// multiple answers, return any
// of them.
// https://leetcode.cn/problems/ip-to-cidr/
public class LeetCode_0751_IPToCIDR {
