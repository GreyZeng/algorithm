...
// 最优解
// 最后调整的样子,一定是V型
// 每对位置(i,i+1)必须作为波谷的最低代价
// 预处理数组
// dp1[i] 0~i想都下坡,总代价是多少?
// dp2[i] i~n-2想都上升,总代价是多少?
// 动态规划解 类似@Code_0101_RestoreWays 这个题目
// 虽然不是最优解,但是技巧很重要.
// 平凡解, 优化枚举行为,递推过程中,最优解存一下.
public class Code_0118_MinCostToYeahArray {
