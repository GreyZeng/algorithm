...
import list.LeetCode_0876_MiddleOfTheLinkedList.ListNode;
...
public class LeetCode_0234_PalindromeLinkedList {
	...
	public boolean isPalindrome2(ListNode head) {
		...
		Stack<Integer> stack = new Stack<>();
		// 如果是偶数，就返回下中点，如果是奇数，就返回中点上一个位置
		ListNode mid = middleNode(head, stack);
		while (mid != null) {
	...
	// 到这个方法，至少有三个节点
	// 如果是偶数，就返回下中点，如果是奇数，就返回中点下一个位置
	private ListNode middleNode(ListNode head, Stack<Integer> stack) {
		ListNode slow = head;
