...
/**
 * 打印数组的全部排列(无重复) <a href="https://leetcode-cn.com/problems/permutations/">打印数组的全部排列(无重复）</a>
 * 笔记见：https://www.cnblogs.com/greyzeng/p/16749313.html LintCode要求使用递归和非递归两种方式实现
 *
