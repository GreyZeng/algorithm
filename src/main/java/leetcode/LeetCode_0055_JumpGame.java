 ...
 * steps to the last index. Example 2:
 *
 * <p>Input: nums = [3,2,1,0,4] Output: false Explanation: You will always arrive at index 3 no
 * matter what. Its maximum jump length is 0, which makes it impossible to reach the last index.
 *
 * <p>
 *
 * <p>Constraints:
 *
 * <p>1 <= nums.length <= 3 * 10^4 0 <= nums[i][j] <= 10^5
 */
