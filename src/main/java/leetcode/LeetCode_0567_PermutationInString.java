...
public class LeetCode_0567_PermutationInString {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < testTimes; i++) {
            ...
            int ans1 = checkInclusion1(str, aim);
            int ans2 = checkInclusion2(str, aim);
            int ans3 = checkInclusion3(str, aim);
    ...
    public static boolean checkInclusion(String s1, String s2) {
        return checkInclusion3(s2, s1) != -1;
    }

    public static int checkInclusion1(String s, String a) {
    ...
    public static int checkInclusion2(String s, String a) {
        if (s == null || a == null || s.length() < a.length()) {
            return -1;
        }
    ...
    public static int checkInclusion3(String s1, String s2) {
