...
// 树链刨分，整颗数一定可以被重链和轻链分解
// 处理在线，O（N）生成，树链刨分，每次查询O(logN)
// targen算法，离线处理，O(N+M)
public class Code_0117_LCATarjanAndTreeChainPartition {
  ...
  public static void process(
      int head, int[][] mt, int[][] mq, int[][] mi, UnionFind uf, int[] ans) {
