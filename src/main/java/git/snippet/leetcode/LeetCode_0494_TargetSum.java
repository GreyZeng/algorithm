 ...
 * Constraints:
 *
 * The length of the given array is positive and will not exceed 20. The sum of elements in the
...
// 4.P 是正数集合，N是负数集合，P - N= target ---> 2P = target + N + P --> P = (target + sum) /
// 2，如果某个累加和等于P，则得到一种情况
// 5. 空间压缩技巧
...
public class LeetCode_0494_TargetSum {
  ...
  public static int process2(
      int[] arr, int index, int rest, HashMap<Integer, HashMap<Integer, Integer>> dp) {
