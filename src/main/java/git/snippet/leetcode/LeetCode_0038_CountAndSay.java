 ...
 *
 * 1. 1 2. 11 3. 21 4. 1211 5. 111221 1 is read off as "one 1" or 11. 11 is read off as "two 1s" or
 ...
 *
 * Input: 4 Output: "1211" Explanation: For n = 3 the term was "21" in which we have two groups "2"
 * and "1", "2" can be read as "12" which means frequency = 1 and value = 2, the same way "1" is
