...
// 二维数组转成一维数组
// 宽度优先遍历
public class LeetCode_0934_ShortestBridge {
  ...
  public static int infect(
      int[][] m, int i, int j, int N, int M, int[] curs, int index, int[] record) {
  ...
  public static int bfs(
      int N, int M, int all, int V, int[] curs, int size, int[] nexts, int[] record) {
