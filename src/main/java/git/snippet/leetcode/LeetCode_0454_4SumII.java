 ...
 * integers are in the range of -2^28 to 2^28 - 1 and the result is guaranteed to be at most 2^31 -
 * 1.
 *
 * Example:
 *
 ...
 * Output: 2
 *
 * Explanation: The two tuples are: 1. (0, 0, 0, 1) -> A[0] + B[0] + C[0] + D[1] = 1 + (-2) + (-1) +
