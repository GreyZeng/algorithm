...
/**
 * Your Skiplist object will be instantiated and called as such: Skiplist obj = new Skiplist();
 * boolean param_1 = obj.search(target); obj.add(num); boolean param_3 = obj.erase(num); Note that
...
class Skiplist {
  ...
  private static final double POSSIBLE = 0.5d;
