 ...
 * than all currently landed squares.
 *
 ...
 * length surface they touch (either the number line or another square).
 *
 ...
 * positions[0] = [1, 2]: _aa _aa ------- The maximum height of any square is 2.
 *
 * After the second drop of positions[1] = [2, 3]: __aaa __aaa __aaa _aa__ _aa__ -------------- The
 * maximum height of any square is 5. The larger square stays on top of the smaller square despite
 * where its center of gravity is, because squares are infinitely sticky on their bottom edge.
 *
 * After the third drop of positions[1] = [6, 1]: __aaa __aaa __aaa _aa _aa___a -------------- The
 * maximum height of any square is still 5.
 *
 ...
 * Example 2:
 *
 * Input: [[100, 100], [200, 100]] Output: [100, 100] Explanation: Adjacent squares don't get stuck
 * prematurely - only their bottom edge can stick to surfaces.
 *
 *
 * Note:
 *
